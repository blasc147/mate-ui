...
export function OutlineCard() {
  return (
    <Card cardStyle="outline" className="w-[572px]" padding="md">
      <CardHeader>
...
export function ShadowCard() {
  return (
    <Card cardStyle="shadow" className="w-[572px]" padding="md">
      <CardHeader>
        <CardTitle supportiveText="supportive text" size="md">
          Cart Title
        </CardTitle>
...
export function SmallPaddingCard() {
  return (
    <Card cardStyle="outline" className="w-[572px]" padding="sm">
      <CardHeader>
        <CardTitle supportiveText="supportive text" size="md">
          Cart Title
        </CardTitle>
